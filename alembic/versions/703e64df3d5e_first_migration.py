...
Revision ID: 703e64df3d5e
Revises: 
Create Date: 2023-02-23 20:48:31.957219
...
def upgrade():
    ...
    with open(os.path.join(os.path.dirname(__file__), "../test_data/students.json")) as f:
        student_data = f.read()
